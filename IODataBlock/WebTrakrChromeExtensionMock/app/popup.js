...
/* Start - Set up event handlers and inject send_links.js into all frames in the active tab. */
/* Start - Set up event handlers and inject send_links.js into all frames in the active tab. */
/* Start - Set up event handlers and inject send_links.js into all frames in the active tab. */
...
/* End - Set up event handlers and inject send_links.js into all frames in the active tab. */
/* End - Set up event handlers and inject send_links.js into all frames in the active tab. */
/* End - Set up event handlers and inject send_links.js into all frames in the active tab. */
...
/* Start - Display LinkedIn Company Elements */
/* Start - Display LinkedIn Company Elements */
/* Start - Display LinkedIn Company Elements */
...
/* End - Display LinkedIn Company Elements */
/* End - Display LinkedIn Company Elements */
/* End - Display LinkedIn Company Elements */


/* Start - Do background LinkedInCompanyDto scrape */
/* Start - Do background LinkedInCompanyDto scrape */
/* Start - Do background LinkedInCompanyDto scrape */
...
/* End - Do background LinkedInCompanyDto scrape */
/* End - Do background LinkedInCompanyDto scrape */
/* End - Do background LinkedInCompanyDto scrape */


/* Start - Display LinkedIn Profile Elements */
/* Start - Display LinkedIn Profile Elements */
/* Start - Display LinkedIn Profile Elements */
...
function DisplayLinkedInProfileTracked(json) {
    ...
    DisplayLinkedInProfileBase(json);
};

function DisplayLinkedInProfileUnTracked(json) {

    $("#linkedInCompanyTab_LinkedInProfileName").html("<a href='javascript:void();'><img id='linkedInCompanyTab_LinkedInProfileName_Icon' src='img/In-2C-21px-R.png'/></a> " + json.LinkedInFullName + " <span id='linkedInProfileTab_TrackingBadge' class='label label-default'>Track Now!</span>");
    DisplayLinkedInProfileBase(json);
};

function DisplayLinkedInProfileBase(json) {
...
/* End - Display LinkedIn Profile Elements */
/* End - Display LinkedIn Profile Elements */
/* End - Display LinkedIn Profile Elements */
