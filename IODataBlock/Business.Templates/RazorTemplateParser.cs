...
namespace Business.Templates
{
    public class RazorTemplateParser
    {
        ...
        public String RenderItemTemplateFromFile(Func<dynamic, String> templateModelFunction, dynamic model)
        {
            var template = File.ReadAllText(templateModelFunction(model));
