...
namespace Business.Common.Extensions
{
    public static class ClassExtensions
    {
        ...
        {
            var converterList = new List<JsonConverter>(converters);
            converterList.Add(new ExpandoObjectConverter());
            converterList.Add(new StringEnumConverter());
        ...
        {
            if (!settings.Converters.Any(x => x.GetType() == typeof(ExpandoObjectConverter))) settings.Converters.Add(new ExpandoObjectConverter());
            if (!settings.Converters.Any(x => x.GetType() == typeof(StringEnumConverter))) settings.Converters.Add(new StringEnumConverter());
